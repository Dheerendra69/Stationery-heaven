...
//     const product = products.find(product => product.id === parseInt(cartItem.product_id));
//     if (product) {
...
// //     total += product.price;
// // }else{
// //     console.log("Element not found in product");
// // }
...
// //     shoppingCart.forEach(item=>{
//         // const product = products.find(p => {
//         //     console.log(p.id+" "+item.product_id);
