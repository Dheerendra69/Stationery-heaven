// Client-side JavaScript (placeOrder.js)
...
document.getElementById('order-form').addEventListener('submit', function(event) {
    ...
    fetch('/saveOrder', {
        ...
        body: JSON.stringify({
            ...
            items: getItemsData(), // Call function to collect items data
            shop: document.getElementById('shop').value
        })
    })
    .then(response => {
        if (response.ok) {
            // Call function after successful submission (optional)
            // callYourFunction();
...
// Function to set orderId field value
function setOrderId() {
...
// Call setOrderId function when the page is loaded or refreshed
